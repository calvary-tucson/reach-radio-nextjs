 ...
 * Run from repo root: node .claude/skills/run-reach-radio-nextjs/driver.mjs [--port 3000]
 *
 * Screenshots land in .claude/skills/run-reach-radio-nextjs/shots/
 */
...
const SHOTS = resolve(ROOT, '.claude/skills/run-reach-radio-nextjs/shots')
