...
const SIZE_PX: Record<AvatarSize, number> = {
  xs: 24, sm: 38, md: 48, lg: 72, xl: 80, '2xl': 128, '3xl': 176,
}

const FONT_CLASS: Record<AvatarSize, string> = {
  xs: 'text-[8px]', sm: 'text-[11px]', md: 'text-[14px]', lg: 'text-[22px]', xl: 'text-[26px]', '2xl': 'text-[42px]', '3xl': 'text-[58px]',
}

const CIRCLE_RADIUS = 'rounded-full'
const ROUNDED_RADIUS: Record<AvatarSize, string> = {
  xs: 'rounded-[4px]', sm: 'rounded-[11px]', md: 'rounded-[12px]', lg: 'rounded-[16px]', xl: 'rounded-[18px]', '2xl': 'rounded-[28px]', '3xl': 'rounded-[36px]',
}
