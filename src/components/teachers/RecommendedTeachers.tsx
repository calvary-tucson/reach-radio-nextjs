  ...
  return (
    <section className="mb-4 md:mb-6" aria-label="Recommended teachers">
      ...
      <div className="relative">
        ...
        <div className="pointer-events-none absolute inset-y-0 right-0 w-20 bg-gradient-to-l from-[var(--color-brand-purple)] light:from-white from-30% to-transparent md:hidden" />
